...
//   }
   ...
   if (event_name){
      ...
      newSpan.setAttribute('id', 'wtstimer1313818');
      ...
      var myWait = setInterval(function () {if (document.getElementById('wts_ui_1313818') != null) {clearInterval(myWait);updateCount();}}, 200);
...
function doPing(delay) { 
   if (document.getElementById('wtstimer1313818').innerHTML != ''){
      delay = delay+1000;
      sendPing(delay);
      if (delay < 60000){
         setTimeout(function() {doPing(delay);}, delay);
...
function sendPing(delay) {
   // var prefix = 'https:' == document.location.protocol ? 'https://server2.web-stat.com' : 'http://server2.web-stat.com';
    var uniqueID = document.getElementById('wtstimer1313818').innerHTML;
    if (uniqueID != ''){
       uniqueID = uniqueID+'::'+delay+'::test';
        // var msg =  prefix+'/ping_timer.pl?'+uniqueID;
         var msg = document.location.protocol+'//server2.web-stat.com/ping_timer.pl?'+uniqueID;
...
function onBlur() {
   document.getElementById('wts_live_1313818').innerHTML = 'off'
   document.getElementById('live_1313818').style.top = '12px';
   document.getElementById('live_1313818').style.marginLeft = '-4px';
   document.getElementById('live_1313818').style.fontSize = '7px';
   document.getElementById('dot_1313818').style.color='#C8322D';
   document.getElementById('live_1313818').innerHTML = 'PAUSED';

};
function onFocus(){
   document.getElementById('wts_live_1313818').innerHTML = 'on'
   document.getElementById('live_1313818').style.top = '13px';
   document.getElementById('live_1313818').style.marginLeft = '0px';
   document.getElementById('live_1313818').style.fontSize = '9px';
   document.getElementById('dot_1313818').style.color='#58C23D';
   document.getElementById('live_1313818').innerHTML = 'LIVE';
   document.getElementById('delay_1313818').innerHTML = '3000';
   updateCount();
};

function updateCount() {
   if (document.getElementById('wts_live_1313818').innerHTML == 'on'){
      window.onblur = onBlur;
      window.onfocus= onFocus;
   }
   var delta_time =  document.getElementById('wts_delta_1313818').innerHTML;
   var userID =  document.getElementById('wts_ui_1313818').innerHTML;
   var msg = document.location.protocol+'//server2.web-stat.com/ping_display_timer.pl?5:1313818:'+delta_time+':'+userID;
...
function stateChanged() {
   ...
   if (ajaxRequest.readyState==4) {
      ...
      if (ajaxRequest.status==200) {
         ...
         var previous_count = document.getElementById('last_count_1313818').innerHTML;
         var previous_delay = document.getElementById('delay_1313818').innerHTML;
         if (response[0] == 'OK'){
            ...
            document.getElementById('wts_sticker_v_1313818').innerHTML = response[1];
            document.getElementById('wts_sticker_o_1313818').innerHTML = response[2];
            document.getElementById('last_count_1313818').innerHTML = response[3];
            document.getElementById('delay_1313818').innerHTML = delay;

            if (document.getElementById('wts_sticker_v_1313818').offsetWidth > 50){
               document.getElementById('wts_sticker_v_1313818').style.marginLeft = '30px';
               document.getElementById('holder_1313818').style.textAlign = 'left';
            }

            if (document.getElementById('wts_live_1313818').innerHTML == 'on' && document.getElementById('wts_prm_1313818').innerHTML == 'premium'){
               document.getElementById('dot_1313818').style.opacity='0';
...
function showGreenDot(opacity){
   document.getElementById('dot_1313818').style.opacity=opacity;
   if (opacity < 1){
